...
const scrollPrograms = (evt) => {
  console.log('mousemove')
}

// programsContainer.addEventListener('mousemove', scrollPrograms);
// programsContainer.addEventListener('mouseup', scrollPrograms);
// programsContainer.addEventListener('scroll', scrollPrograms);
